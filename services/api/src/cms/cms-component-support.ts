...
export const CMS_COMPONENT_SUPPORT_MATRIX: Record<string, CmsComponentSupportMeta> = {
  ...
  "login-card": supported("登录欢迎卡", "H5/小程序完整支持微信头像昵称登录引导、登录后头像昵称展示和跳转配置。"),
  ...
  "promotion-bar": supported("运营引导条", "H5/小程序支持图标、标题、按钮和统一跳转的一行运营引导条。"),
  ...
  "dual-track-tags": supported("双赛道标签条", "H5/小程序支持双行标签、右侧按钮和统一跳转配置。"),
