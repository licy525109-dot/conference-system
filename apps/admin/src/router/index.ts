...
export const routes: AdminRoute[] = [
  ...
  { path: "/inventory-alerts", title: "库存预警", menuTitle: "库存预警", group: "会议管理", badge: "灰度", description: "会议库存阈值、扫描任务和预警日志入口。", permission: "inventory-alert:view", component: OperationalWorkflowsPage },
  { path: "/checkin/verify", title: "签到核销", menuTitle: "签到核销", group: "会议管理", badge: "灰度", description: "扫码核销、手动核销和重复核销拦截入口。", permission: "registration:view", component: OperationalWorkflowsPage },
  { path: "/checkin/logs", title: "签到记录", menuTitle: "签到记录", group: "会议管理", badge: "灰度", description: "签到核销日志和撤销记录入口。", permission: "registration:view", component: OperationalWorkflowsPage },
  { path: "/checkin/stats", title: "签到统计", menuTitle: "签到统计", group: "会议管理", badge: "灰度", description: "会议签到率、票种签到率和异常统计入口。", permission: "registration:view", component: OperationalWorkflowsPage },
  ...
  { path: "/finance/wechat-bills", title: "微信账单", menuTitle: "微信账单", group: "财务管理", badge: "辅助", description: "微信账单申请、下载和对账入口。", permission: "finance:view", component: OperationalWorkflowsPage },
