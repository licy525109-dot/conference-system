...
export const materialSpecs = {
  ...
  animatedIcon: spec("动图图标", "96x96 或 128x128", "GIF/APNG/WebP/PNG/SVG", 500 * KB, "用于图标入口、顶部标题等轻量动效，建议控制帧数和透明边距，避免影响小程序首屏加载。", ["image/gif", "image/apng", "image/webp", "image/png", "image/svg+xml"]),
